...
extension Section {
    ...
    static var badgeViewData: [Section] {
        return [
            ...
            Section(title: "Section 2", data: [Int](1...13), cellType: NestedCell.self, headerType: TitleHeaderView.self, layout: { sectionIndex,_,_,_,collectionViewLayout in
            ...
            Section(title: "Section 3", data: [Int](14...21), cellType: NestedCell.self, headerType: TitleHeaderView.self, layout: { sectionIndex,_,_,_,collectionViewLayout in
